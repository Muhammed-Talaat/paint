...
//		   oldShape.f_y2=sh.f_y2;
   ...
   public List<Shape> undo() {
	 if(actionIndex>-1) {
	   if(UserActions.get(actionIndex).action=="delete") {
		  allShapes.add(UserActions.get(actionIndex).old);
		   
	   }
	   else if (UserActions.get(actionIndex).action=="changeLocation") {
	   ...
	   else if (UserActions.get(actionIndex).action=="color") {
		   Shape sh=getShapeById(UserActions.get(actionIndex).old.id);
		   sh.fillColor=UserActions.get(actionIndex).old.fillColor;
		   
	   }
	   else if (UserActions.get(actionIndex).action=="add") {
